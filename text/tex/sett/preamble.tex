...
% citestyle=authoryear-comp, nastaví zapis jako autor, rok
% sorting=ynt serazeni podle roku
% Change the name format for the bibliography
%\usepackage{natbib}
%\bibliographystyle{acm}

\DeclareNameAlias{default}{family-given}
%\bibliography{bib/thesis_bibliography.bib}
