...
## Popis
Autoři navazují na svou předchozí práci (CloudS2Mask) a představují jak trénovat model, který bude schopný přesné detekce na datech z více různých senzorů (navzdory tomu, že je trénován na datech z jednoho). Autoři dosáhli nejlepších výsledků ze všech porovnávaných metod.
